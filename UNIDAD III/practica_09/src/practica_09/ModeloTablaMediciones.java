...
public class ModeloTablaMediciones extends AbstractTableModel {
    ...
    String encabezados[] = new String[]{
        "ID","Fecha","Estatura(cm)", "Peso(kg)", "Cintura(cm)", "Cadera(cm)","Tipo de Act"
    };
    ...
    ModeloTablaMediciones(String Usuario, String Contraseña) {
        try {
...
//  usa el modelo de tabla creada por el usuario
    ...
    public void actualizaEstatusMedidas(String sql) {
